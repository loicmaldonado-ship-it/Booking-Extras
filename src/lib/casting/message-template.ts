...
// La signature apparaît toujours en dernier, après le corps du message —
// jamais une formule générique du style "L'équipe casting", pour que le
// figurant sache qui lui écrit réellement. {signature} se résout côté
// composeur (voir getProjetSignatureOrOwnerName) sur la signature calibrée
// du projet, ou à défaut le nom de la cheffe propriétaire.
